            ...
            <div class="row">
               ...
               <div class="col-xl-3 col-md-6">
                  <div class="widget">
                     <div class="row">
                        <div class="col-sm-12">
                           <img src="{{asset('assets')}}/images/logo-1.png" class="gen-footer-logo" alt="gen-footer-logo">
               ...
               <!-- العمود الرابع (Download App) يبقى كما هو -->
               <div class="col-xl-3  col-md-6">
                  <div class="widget">
                     ...
                     <div class="row">
                        <div class="col-sm-12">
                           <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                           <a href="#">
                              <img src="{{asset('assets')}}/images/asset-35.png" class="gen-playstore-logo" alt="playstore">
                           </a>
                           <a href="#">
                              <img src="{{asset('assets')}}/images/asset-36.png" class="gen-appstore-logo" alt="appstore">
                           </a>
                        </div>
                     </div>
                  </div>
